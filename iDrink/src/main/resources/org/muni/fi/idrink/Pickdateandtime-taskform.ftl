...
<div id="container">
	<div id="header">
		User Task Form: Reservation.Pickdateandtime
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="start" type="text" class="textbox" id="start" value="${start}" />
                            		</div>
              	
                            		<label for="name">end</label>
                            		<div class="div_texbox">
                              		<input name="end" type="text" class="textbox" id="end" value="${end}" />
                            		</div>
